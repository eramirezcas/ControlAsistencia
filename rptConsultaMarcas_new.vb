...
Public Class rptConsultaMarcas_new
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptConsultaMarcas_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptConsultaMarcas_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pNombre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptConsultaMarcas_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsultaMarcas_new = New rptConsultaMarcas_new()
        rpt.Site = Me.Site
        Return rpt
    End Function
