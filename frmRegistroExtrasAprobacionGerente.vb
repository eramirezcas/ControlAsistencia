Public Class frmRegistroExtrasAprobacionGerente
            ...
            For i = 0 To dts.Tables("tbl_extras").Rows.Count - 1
                If dts.Tables("tbl_extras").Rows(i).Item("aprobado") Or _
                    ...
                    Dim pDetalleBitacora As String = IIf(dts.Tables("tbl_extras").Rows(i).Item("aprobado"), _
                                                         "APROBACIÓN DE GERENTE REALIZADA CON ÉXITO", _
                                                         "RECHAZO DE GERENTE REALIZADO CON ÉXITO") & _
                                                     " POR " & pNombreUser

                    Dim motivoRechazo As String = IIf(dts.Tables("tbl_extras").Rows(i).Item("aprobado"), _
                                                      "NULL", dts.Tables("tbl_Extras").Rows(i).Item("motivo_rechazo_gerente"))
                    ...
                    Dim strSQL As String = _
                        ...
                        "   	  empid_gerente =" & pempID & vbNewLine & _
                        "   	, nombre_gerente ='" & pNombreUser & vbNewLine & "'" & _
                        "   	, fecha_aplica_gerente = GETDATE()" & vbNewLine & _
                        "       , motivo_rechazo_gerente = '" & motivoRechazo & "'" & vbNewLine & _
    ...
    Public Sub CargaGrid()
        Try
            ...
            Dim strSQL As String = "SELECT CAST(0 as bit) as Aprobado, CAST(0 as bit) as Rechazado, id_linea, nDocumento, empID, nombre_empleado, id_Departamento, nombre_departamento," & vbNewLine & _
                                   ...
                                   "WHERE (estatus_nivel = 1)" & IIf(verTodos, "", " AND (empID in (select empid from tbl_empleados_sap as E where " & IIf(pEsGerente, "E.empid_gerente", "E.empid_jefe") & " = " & pempID & "))") & vbNewLine & _
    ...
    Private Sub frmRegistroExtrasAprobacionGerente_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        CargaGrid()
        RegActual()
    End Sub
    ...
    Private Sub btnEnviarGurpo_Click(sender As System.Object, e As System.EventArgs) Handles btnEditar.Click
        Dim obj As New frmRegistroExtrasAprobacionGerenteDetalle()
        obj.pnt = Me
    ...
    Private Sub chkAprobarTodosNinguno_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkAprobarTodosNinguno.CheckedChanged
        ...
        For i = 0 To dts.Tables("tbl_Extras").Rows.Count - 1
            If obj.Checked Then
                ...
                dts.Tables("tbl_Extras").Rows(i).Item("estatus") = "PENDIENTE DE APROBACIÓN RRHH"
