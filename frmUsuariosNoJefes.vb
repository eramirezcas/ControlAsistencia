Public Class frmUsuariosNoJefes
    ...
    Private Function Localizar(ByVal dato As String, ByVal pos As Integer) As Integer
        ...
        If pos <= dtsForm.Tables(Tabla).Rows.Count - 1 Then
            For i = 0 To DataGridView1.Columns.Count - 1
                strLinea += dtsForm.Tables(Tabla).Rows(pos).Item(DataGridView1.Columns(i).DataPropertyName).ToString & vbTab
            Next
        Else
            encontrado = False
            Return -1
    ...
    Public Sub CargaGrid()
        Try
            ...
            DataGridView1.DataSource = dtsForm
            ...
            DataGridView1.Columns(0).HeaderText = "ID Linea"
            DataGridView1.Columns(1).HeaderText = "ID Emp"
            DataGridView1.Columns(2).HeaderText = "Nombre"
            DataGridView1.Columns(3).HeaderText = "Activo"
            DataGridView1.Columns(4).HeaderText = "Usuario"
            DataGridView1.Columns(5).HeaderText = "clave"
            DataGridView1.Columns(6).HeaderText = "verTodos"
            DataGridView1.Columns(7).HeaderText = "email"

            DataGridView1.Columns(1).Width = 50
            DataGridView1.Columns(2).Width = 250
            DataGridView1.Columns(3).Width = 83
    ...
    Private Sub dgvHorarios_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.SelectionChanged
        RegActual()
    End Sub

    Private Sub dgvHorarios_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        RegActual()
    End Sub
    ...
    Private Sub dgvHorarios_CellDoubleClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
    ...
    Private Sub frmUsuariosNoJefes_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        CargaGrid()
        BindingContext(dtsForm, Tabla).Position = 0
        RegActual()
    End Sub
