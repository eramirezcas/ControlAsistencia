Public Class frmRegistroExtrasAprobacionGerenteDetalle
    ...
    Private Sub cargaMontoPendiendes(ByVal p_empId As Integer)
        Try
            ...
            Dim obj As Object = cnx.SQLEXECESCALAR(strSQL)
            Dim nume As Decimal = CType(obj, Decimal)
            txtMontoPendiente.Tag = nume
    ...
    Private Sub btnGuardar_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar.Click
        ...
        dts.Tables("tbl_Extras").Rows(pos).Item("estatus") = "PENDIENTE DE APROBACIÓN RRHH"
    ...
    Private Sub btnRechazar_Click(sender As System.Object, e As System.EventArgs) Handles btnRechazar.Click
        ...
        If txtMotivoRechazo.Text = "" Or IsDBNull(dts.Tables("tbl_Extras").Rows(pos).Item("fecha_aplica_jefe")) Then
    ...
    Private Sub frmRegistroExtrasAprobacionGerenteDetalle_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub frmRegistroExtrasAprobacionGerenteDetalle_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If Not nuevo Then
