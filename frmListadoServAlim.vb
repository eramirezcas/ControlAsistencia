Public Class frmListadoServAlim
    ...
    Public Sub CargaGrid()
        Try
            ...
            DataGridView1.Columns(4).HeaderText = "MONTO"
    ...
    Private Sub btnExportaexcel_Click(sender As Object, e As EventArgs) Handles btnExportaexcel.Click
        Try
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                xlSht.Cells((fil + 4) + i, col + 4) = dt.Rows(i).Item("MONTO")
            Next
    ...
    Private Sub btnCargar_Click(sender As Object, e As EventArgs) Handles btnCargar.Click
        Try
            ...
            Dim strsql As String = _
                ...
                "	,(SELECT MontoServicioAlimentacion FROM tbl_control_alimentacion_parametros) AS MONTO" & vbNewLine & _
                "FROM view_sl_empleados" & vbNewLine & _
                "WHERE ACTIVO='S' AND SERVICIO_ALIMENTACION = 1" & vbNewLine & _
