...
Public Class rptMarcasHist_new
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptMarcasHist_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTitulo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pFiltro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMarcasHist_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMarcasHist_new = New rptMarcasHist_new()
        rpt.Site = Me.Site
        Return rpt
    End Function
